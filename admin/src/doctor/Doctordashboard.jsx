...
const Doctordashboard = () => {
  const { backendurl, doctorpass, loading, setloading } =
  ...
  const cancelappointment = async (id) => {
    ...
    try {
      const { data } = await axios.post(
        `${backendurl}/doctor/cancelappointment`,
        { id },
        {
          withCredentials: true,
        }
  ...
  return (
    <div className="w-full ">
      ...
      <div className="flex flex-wrap items-center justify-center gap-7">
        ...
        <div className="w-64 h-32 bg-zinc-100 rounded-md shadow-lg">
          <div className="flex items-center justify-center w-64 h-32 bg-zinc-100 rounded-md shadow-lg gap-4">
            <FaUser size={40} />
            <div className="text-xl">
              <p>{loading ? <Loadingtwo /> : dashboarddata.patients ? dashboarddata.patients : 0}</p>
        ...
        <div className="w-64 h-32 bg-zinc-100 rounded-md shadow-lg">
          <div className="flex items-center justify-center w-64 h-32 bg-zinc-100 rounded-md shadow-lg gap-4">
            <SlCalender size={40} />
            <div className="text-xl">
              <p>{loading ? <Loadingtwo /> : dashboarddata.totalappointments ? dashboarddata.totalappointments : 0}</p>
      ...
      <p className="flex items-center gap-1 font-semibold py-10 px-5">
          ...
          dashboarddata.latestappointments.map((item, index) => (
            ...
            >
              ...
              {item.cancelled && !item.iscompleted ? (
                <p className="font-semibold text-red-600 mt-8 md:mt-6 lg:mt-5 px-4  md:px-0 lg:px-0">
                  Cancelled
                </p>
              ) : item.iscompleted ? (
                <p className="font-semibold text-red-600 mt-8 md:mt-6 lg:mt-5  px-4  md:px-0 lg:px-0">
                ...
                <img
                  ...
                  className="w-10 h-10 mt-5 md:mt-4 lg:mt-3 px-4  md:px-0 lg:px-0"
